...
<html lang="en" dir="ltr">
  ...
  <body>
   ...
   <p>Head over to <a href="https://console.helium.com/" target="_blank">Helium Console</a> and setup an account if you 
      ...
      save the file as something like "Weather Monitor Keys".<br><br><img src="images/heliumedeveui.png" alt="" width="500px" height="auto"><br><br> The Weather Monitor walkthrough above provides you with <a href="https://github.com/RAKWireless/WisBlock/blob/master/examples/RAK4630/solutions/Weather_Monitoring/Weather_Monitoring.ino" target="_blank">this Weather-Monitor Sketch</a>. Copy and paste that code into your Arduino IDE, it should look like this:</p>
...
Navigate to Configuration and down to your Decoder. Scroll down to line 60 of your Decoder, replace it with '}' and hit enter. Paste the following function:
  ...
  <p>Place another '}' below, and hit enter again. It should look like this:</p><br><img src="images/datacakefunction.png" alt="" width="850px" height="auto">
    ...
    <p>Rather than editing the codes yourself, you can download the complete <a href="https://github.com/ilovespectra/ilovespectra/blob/main/RAK4631/Weather-Monitor/Weather-Monitor-US915.ino" target="_blank">Arduino Sketch</a> and <a href="https://github.com/ilovespectra/ilovespectra/blob/main/RAK4631/Weather-Monitor/Datacake%20Decoder" target="_blank">Datacake Decoder</a> modified for US915. <b>You'll still need to <a href="https://github.com/ilovespectra/ilovespectra/blob/main/RAK4631/Weather-Monitor/Weather-Monitor-US915.ino" target="_blank">follow these instructions</a> add  your OTAA DevEui, AppEui, and AppKey to the Arduino sketch.</b> Copy the raw contents from the link for the Arduino Sketch above and paste it into Arduino IDE to enter your devices info. The location for where to do so is indicated in the comments. Then you just have to  <a href="https://github.com/ilovespectra/ilovespectra/edit/main/RAK4631/Weather-Monitor/README.md#compile-the-weather-monitor-arduino-sketch" target="_blank">compile</a> and upload the arduino sketch to your weather monitor and proceed with the <a href="https://github.com/ilovespectra/ilovespectra/tree/main/RAK4631/Weather-Monitor#configuring-datacake" target="_blank">Datacake instructions</a>, modify and <a href="https://github.com/ilovespectra/ilovespectra/edit/main/RAK4631/Weather-Monitor/README.md#save-the-decoder" target="_blank">save the deocoder</a>   and pick back up  <a href="https://github.com/ilovespectra/ilovespectra/edit/main/RAK4631/Weather-Monitor/README.md#setting-up-your-datacake-dashboard" target="_blank">here</a>.</p>
    <h3>Setting up your Datacake Dashboard</h3>
    <p>Navigate to your Configuration window on Datacake, and scroll down past your Decoder in your "Fields" to "Temperature" and select "Add Mapping Field"</p><br><img src="images/datacakeaddmap.png" alt="" width="900px" height="auto"><br>
